    ...
    <main className="flex min-h-screen flex-col items-center justify-between" style={{ backgroundColor: '#E7E7E7' }}>
      ...
      <div style={{ width: 305, height: 542, background: '#D2DCF0', borderRadius: 42, display: 'flex', flexDirection: 'column', marginBottom: '90px', alignItems: 'center', position: 'relative', zIndex: '1' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '20px' }}>
          ...
          <button onClick={gitHubSignIn} style={{ width: 198, height: 40, display: 'flex', alignItems: 'center', background: '#24292E', borderRadius: 50, justifyContent: 'center', marginTop: '20px' }}>
            <p style={{ color: 'white', fontSize: '18px', fontFamily: 'Inter, sans-serif', fontWeight: '900', fontStyle: 'italic' }}>Sign in with GitHub</p>
          </button>
        </div>
      </div>
      <div style={{
